...
<div class="shareholders">
    <div class="m_b16">
        ...
        <Button class="m_r16" type="primary" @click="search">查找</Button>
    ...
    <Modal
        ...
        <Form ref="formDetail" :model="formDetail" :rules="ruleValidate" :label-width="80">
            ...
            <FormItem label="账户余额" prop="name">
                <Input v-model="formDetail.balanceOf" />
            </FormItem>
...
export default {
    ...
    mounted(){
        this.$http({
            method:"get",
            url:"http://192.168.124.28:3000/getShareList"
        }).then((res)=>{
            console.log(res);
        },(rej)=>{
            console.log(rej);
